...
public interface HotelLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HotelLocalServiceUtil} to access the hotel local service. Add custom service methods to {@link com.demo.workflow.core.service.impl.HotelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Hotel addItemsInList(long userId, int pizzaConut, int burgerCount,
		int DoughnutCount);

	public Hotel addItemsInList(ServiceContext serviceContext, int pizzaConut,
		int burgerCount, int DoughnutCount);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Hotel> getItemsByStatus(long groupId, int status, int start,
		int end);
	...
	*/
	...
	public Hotel updateStatus(long userId, long orderId, int status,
